...
2. Place the entire built extension folder (`com.donyaep.TimerKeeper`) in this directory. The release zip holds the extension files directly, so extract them into a folder with that name.
